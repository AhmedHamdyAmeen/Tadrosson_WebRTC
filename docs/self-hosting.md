...
```bash
# Tadrosoon P2P - HTTPS — proxy all requests to the Node app
server {
	# Enable HTTP/2
...
Check Your Tadrosoon P2P instance: https://your.domain.name

---

## Update script

In order to have always Your Tadrosoon P2P updated to latest, we going to create a script
...
Follow the commits of the Tadrosoon P2P project [here](https://github.com/miroslavpejic85/Tadrosoon/commits/master)

To update Your Tadrosoon P2P instance at latest commit, execute:
